//
//  GJHRDMCustomModalViewController.h
//  GJHRDMCustomModalViewController
//
...
typedef NS_ENUM(NSInteger, GJHRDMCustomModalViewControllerPresentationStyle) {
    GJHRDMCustomModalViewControllerPresentFullScreen,
    GJHRDMCustomModalViewControllerPresentPartScreen
};

typedef void (^GJHRDMModalDidCloseCompletion)();

@class GJHRDMCustomModalViewController;

@protocol GJHRDMCustomViewControllerDelegate <NSObject>
@optional
/**
 ...
 */
- (void)customModalViewControllerDidDismiss:(GJHRDMCustomModalViewController *)modalViewController;
@end
...
@property (nonatomic, unsafe_unretained) id<GJHRDMCustomViewControllerDelegate> delegate;
/**
 ...
 */
@property (nonatomic, copy) GJHRDMModalDidCloseCompletion closeCompletionBlock;
