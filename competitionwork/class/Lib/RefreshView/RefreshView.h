...
#define REFRESH_LOADING_STATUS @"努力加载中..."
#define REFRESH_PULL_DOWN_STATUS @"下拉即可刷新"
#define REFRESH_RELEASED_STATUS @"释放即可刷新"
#define REFRESH_UPDATE_TIME_PREFIX @"上次更新: "
//#define REFRESH_HEADER_HEIGHT 60
#define REFRESH_TRIGGER_HEIGHT 80
...
@property (nonatomic,assign) BOOL isUIPushInfoListController;
